...
void concreteSettingsMapFuncInt(int changescale, const String& printUpperRow, const String& measurementUnits, int upperBound, int lowerBound, int EEPROMADRESS){
...
void concreteSettingsMapFuncFloat(float changescale, const String& printUpperRow, const String& measurementUnits, float upperBound, float lowerBound, int EEPROMADRESS){
  updateIfNeeded();
  lcd.setCursor(0, 0);
  lcd.print(printUpperRow);
  lcd.setCursor(0, 1);
